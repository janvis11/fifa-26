...
STADIUMS: Dict[str, Dict[str, Any]] = {
    "metlife": {
        ...
        "zones": ["Concourse A", "Concourse B", "Concourse C", "Concourse D", "West Plaza", "East Gate"]
    },
    "sofi": {
        "id": "sofi",
        "name": "SoFi Stadium",
        "city": "Inglewood, CA",
        "zones": ["Entry Plaza", "Level 4 Concourse", "Level 6 Concourse", "VIP Club East", "South Canopy"]
    },
    "azteca": {
        "id": "azteca",
        "name": "Estadio Azteca",
        "city": "Mexico City",
        "zones": ["General Concourse", "Preferente Concourse", "Platea Gate", "Special Access Ramp", "Especial Club"]
    },
    "bc_place": {
        "id": "bc_place",
        "name": "BC Place",
        "city": "Vancouver, BC",
        "zones": ["Main Concourse", "Upper Level 400", "Terry Fox Plaza", "West Gate Entrance", "Disabled Seating Deck"]
    }
}
